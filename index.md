...
<meta http-equiv="refresh" content="0; url={{ current_ed.url | relative_url }}">
<link rel="canonical" href="{{ site.url }}{{ current_ed.url | relative_url }}">

Redirecting to the current edition:

[{{ current_ed.id }}]({{ current_ed.url | relative_url }})
